                ...
                <div class="col-md-6">
                    <div class="row" style="padding: 30px 0;">
                        ...
                        <div class="col-md-12" style="text-align: center;"><span
                            style="font-size: 14pt; color: green;"><strong>Bienvenido administrador {{ Auth::user()->usuario }}</strong></span>
                            <br>    
                            <a class="btn btn-outline-success btn-lg" href="{{ URL::to('reports_admin') }}">
                                    Panel de administrador - Reportes</a></strong></span></div>
                        @else
                        @if (Auth::user()->token)
                            <div class="col-md-12" style="text-align: center;"><span
                                    style="font-size: 14pt; color: red;"><strong>Debes de validar tu correo electrónico para
                                        acceder a todas las funcionalidades
                                        <br>
                                        <a class="btn btn-outline-success" href="{{ URL::to('email_validation') }}">
                                            Validar correo</a></strong></span></div>
                        @else
                            <div class="col-md-12" style="text-align: center;"><span
                                    style="font-size: 14pt; color: green;"><strong>¿Tienes dudas? Solicita tu prueba de
                                        COVID-19
                                        sí presentas uno o más síntomas. Llena el formulario en el siguiente botón:

                                        <a class="btn btn-outline-success btn-lg" href="{{ URL::to('studies') }}">
                                            Registrar Estudio</a></strong></span></div>
                        @endif
                        @endif
                    </div>
                                ...
                                <div class="custom">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="text-align: center;"><img
                                                ...
                                                src="{{ asset('img/sintoma8.png') }}" alt="sintoma8"
