                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    class="form-control" name="felaboracion" id="felaboracion" xyz
                                                    readonly>
                                            </div>
                                ...
                                <div id="collapseAddress" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row mt-3">
                                            ...
                                            @if (!empty($reportes[0]->idEvolucion))
                                                <h4>La evolución ya ha sido registrada</h4>
                                            @else
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" name="resultado" id="resultado"
                                                        aria-label="Default select example">
                                                        <option selected disabled value="Caso no grave">Seleccionar...
                                                        </option>
